...
![Uploading a descriptor to register an application.](../img/app.png)
...
![Descriptor uploading dialog](../img/registerapp.png)
...
![Describe connections step on the Deploy Instance dialog](../img/app_instance_deploy_connections.png)
...
![Instance view with graph](../img/instance23.png)

![Instance view with services](../img/instance24.png)
