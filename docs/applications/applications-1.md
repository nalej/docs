...
![Application View from the Web Interface](../img/app.png)
...
![This is the process to follow when deploying an instance of an application.](../img/app_deployment.png)
...
![Upload a descriptor](../img/app_register.png)
...
![Upload descriptor](../img/registerapp.png)

After that, just clicking on the **Register** button will register the application in the system.

![Uploaded descriptor with success](../img/uploaddescriptor.png)
...
![Deploy for the main view](../img/apps_deploybutton.png)
...
![Deploy from registered list options in actions button](../img/deployregistered.png)
...
![Deploy from registered view](../img/deployregistered_fromappview.png)
...
![Basic params](../img/deploybasic.png)
...
![Basic params](../img/deployparam2.png)

![Advanced params](../img/deployparam3.png)

- Lastly, if there is any required connection, we will have to fill the required information for them in the third step.

![App connections options for deploy](../img/deployappconn.png)

![Deploy and advanced app](../img/deployappconn4.png)
...
![Deploy message confirmation](../img/deploymessage.png)
...
![Registered quick filter](../img/appqick2.png)

![Registered and instances quick filter](../img/appquick.png)

![Just instances quick filter](../img/appquick3.png)

![Search with no filter](../img/appsearchnofilter.png)
...
![Advanced filter options](../img/advancedfilter.png)
...
![Instance view with graph](../img/pingsource223.png)

![Instance view with services](../img/pigsource12.png)
...
![Service group info](../img/serviceinstacegroup.png)
...
![Service info dialog](../img/appinstancesserviceinfo.png)
...
![Information for a specific rule](../img/appinstanceruleinfo.png)
...
![Undeploying an instance](../img/appinfolistoptions-1.png)
...
![Deleting an application from the system](../img/deleteregistered_fromappview.png)
