...
![How the connection between the Nalej Management Cluster and the ECs work](../img/infrastructure_inventory_ec_agents.png)
...
![Communication diagram Agent-EC-NMC](../img/infrastructure_inventory_agent_communication.png)
...
![Main list of ECs](../img/infrastructure_ec_ppal.png)
...
![All the info about the EC](../img/infrastructure_ec_moreinfo.png)

Here we can see, apart from the information we already had, the list of assets attached to a specific EC.

**Install agent**

![Info needed to install an agent](../img/infrastructure_ec_installagent.png)
...
![Agent join token](../img/infrastructure_agent_createjointoken.png)
...
![Agent info view](../img/infrastructure_agent_moreinfo.png)
...
![Last operation info](../img/infrastructure_agent_lastopinfo.png)
