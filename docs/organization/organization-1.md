...
![Add user dialog](../img/adduser.png)
...
![Edit user dialog](../img/edituser.png)
...
![User info dialog](../img/userinfo.png)
...
![Change password dialog](../img/pass.png)
...
![Delete user in user info dialog](../img/deleteuser.png)
