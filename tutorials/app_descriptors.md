...
* rule\_id is the identifier of the rule.
* name is the user friendly name of the rule
* source\_service\_id contains the identifier of the source service the rule targets.
* source\_port contains the source port
...
* auth\_services contains a list of service identifiers that access the service.
